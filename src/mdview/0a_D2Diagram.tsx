...
export function D2Diagram({ code, dark }: { code: string; dark: boolean }) {
  ...
  return (
    <>
      ...
      />
      {open && createPortal(
        <div className="mdview-d2-lightbox" role="dialog" aria-modal="true" aria-label="d2 diagram" onClick={() => setOpen(false)}>
          <div className="mdview-d2-lightbox-tools" onClick={(event) => event.stopPropagation()}>
          ...
          <div
            className="mdview-d2-lightbox-stage"
            role="presentation"
          ...
          >
            <div
              className="mdview-d2-lightbox-canvas"
