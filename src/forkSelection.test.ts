...
vi.mock("@hafley66/boop-xterm", () => ({ tokenAtColumn: vi.fn(), widenAcrossSpaces: vi.fn() }));
vi.mock("@hafley66/boop-xterm", () => ({ joinWrappedRows: vi.fn(), capWrappedRows: vi.fn(), softWrappedPathLink: vi.fn(), wrappedLinkSpans: vi.fn(), MAX_WRAP_ROWS: 0 }));
